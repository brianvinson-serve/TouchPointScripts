...
# --- Version -----------------------------------------------------------
# RPC deployment: upstream's auto-update mechanism (fetches code from
# Ben Swaby's TPxi servers and overwrites this Special Content script via
# model.WriteContentPython) has been removed. Update by pulling the latest
# TPxi_RollSheet.py from https://github.com/bswaby/Touchpoint by hand.
APP_VERSION = '1.2.2'                              # upstream version this fork is based on
...
if model.HttpMethod == "post":
    ...
    # -----------------------------------------------------------------
    # apply_update removed for RPC deployment: upstream's version fetched new
    # source from a third-party server and overwrote this Special Content
    # script in place via model.WriteContentPython (no TouchPoint-side role
    # check on that write, per upstream's own code comment). Update by hand
    # from https://github.com/bswaby/Touchpoint instead.
    # -----------------------------------------------------------------
...
(function() {
    ...
    // =====================================================================
    // VERSION (auto-update removed for RPC deployment -- see header note)
    // =====================================================================
    ...
    function ajax(action, params, callback) {
        ...
        // Forwards script_name so server-side get_script_name() can detect a
        // renamed install (harmless now that apply_update is removed).
