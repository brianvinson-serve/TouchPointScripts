# OutstandingTasksList.py - Original from TenthPres
# Generates a list of outstanding tasks for the current user
# Can be used in email templates or as a standalone report
